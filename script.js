...
// ── 한자 검색용 확장 DB (음절·의미·한자) ─────────────────────
const HANJA_SEARCH_DB = [
  // ㄱ
  {h:'佳',m:'아름다울',s:'가'},{h:'嘉',m:'아름다울',s:'가'},{h:'可',m:'옳을',s:'가'},{h:'家',m:'집',s:'가'},
  {h:'加',m:'더할',s:'가'},{h:'歌',m:'노래',s:'가'},{h:'假',m:'거짓',s:'가'},{h:'價',m:'값',s:'가'},
  {h:'街',m:'거리',s:'가'},{h:'珈',m:'머리꾸밈',s:'가'},{h:'伽',m:'절',s:'가'},
  {h:'強',m:'강할',s:'강'},{h:'江',m:'강',s:'강'},{h:'康',m:'편안할',s:'강'},{h:'剛',m:'굳셀',s:'강'},
  {h:'鋼',m:'쇠',s:'강'},{h:'降',m:'내릴',s:'강'},{h:'姜',m:'성씨',s:'강'},
  {h:'建',m:'세울',s:'건'},{h:'健',m:'건강할',s:'건'},{h:'乾',m:'하늘',s:'건'},{h:'騫',m:'날',s:'건'},
  {h:'敬',m:'공경할',s:'경'},{h:'慶',m:'경사',s:'경'},{h:'景',m:'볕',s:'경'},{h:'京',m:'서울',s:'경'},
  {h:'炅',m:'빛날',s:'경'},{h:'競',m:'다툴',s:'경'},{h:'鏡',m:'거울',s:'경'},{h:'耕',m:'밭갈',s:'경'},
  {h:'桂',m:'계수나무',s:'계'},{h:'溪',m:'시내',s:'계'},{h:'啓',m:'열',s:'계'},{h:'繼',m:'이을',s:'계'},
  {h:'高',m:'높을',s:'고'},{h:'古',m:'옛',s:'고'},{h:'固',m:'굳을',s:'고'},{h:'皐',m:'언덕',s:'고'},
  {h:'官',m:'벼슬',s:'관'},{h:'寬',m:'너그러울',s:'관'},{h:'觀',m:'볼',s:'관'},{h:'館',m:'집',s:'관'},
  {h:'光',m:'빛',s:'광'},{h:'廣',m:'넓을',s:'광'},{h:'珖',m:'옥피리',s:'광'},{h:'曠',m:'빌',s:'광'},
  {h:'九',m:'아홉',s:'구'},{h:'球',m:'공',s:'구'},{h:'久',m:'오랠',s:'구'},{h:'求',m:'구할',s:'구'},
  {h:'國',m:'나라',s:'국'},{h:'菊',m:'국화',s:'국'},{h:'局',m:'판',s:'국'},
  {h:'奎',m:'별',s:'규'},{h:'圭',m:'규',s:'규'},{h:'珪',m:'홀',s:'규'},{h:'規',m:'법칙',s:'규'},
  {h:'根',m:'뿌리',s:'근'},{h:'勤',m:'부지런할',s:'근'},{h:'謹',m:'삼갈',s:'근'},
  {h:'基',m:'터',s:'기'},{h:'起',m:'일어날',s:'기'},{h:'琦',m:'아름다운옥',s:'기'},{h:'期',m:'기약할',s:'기'},
  {h:'吉',m:'길할',s:'길'},{h:'佶',m:'건장할',s:'길'},
  // ㄴ
  {h:'那',m:'어찌',s:'나'},{h:'娜',m:'아름다울',s:'나'},{h:'羅',m:'벌일',s:'나'},
  {h:'南',m:'남쪽',s:'남'},{h:'楠',m:'녹나무',s:'남'},{h:'男',m:'사내',s:'남'},
  {h:'女',m:'계집',s:'녀'},{h:'汝',m:'너',s:'녀'},
  // ㄷ
  {h:'多',m:'많을',s:'다'},{h:'茶',m:'차',s:'다'},{h:'達',m:'통달할',s:'다'},
  {h:'丹',m:'붉을',s:'단'},{h:'端',m:'끝',s:'단'},{h:'旦',m:'아침',s:'단'},{h:'檀',m:'박달나무',s:'단'},
  {h:'大',m:'클',s:'대'},{h:'代',m:'대신할',s:'대'},{h:'戴',m:'일',s:'대'},{h:'臺',m:'대',s:'대'},
  {h:'德',m:'덕',s:'덕'},{h:'悳',m:'덕',s:'덕'},
  {h:'道',m:'길',s:'도'},{h:'都',m:'도읍',s:'도'},{h:'度',m:'법도',s:'도'},{h:'圖',m:'그림',s:'도'},
  {h:'東',m:'동쪽',s:'동'},{h:'動',m:'움직일',s:'동'},{h:'桐',m:'오동나무',s:'동'},{h:'童',m:'아이',s:'동'},
  // ㄹ
  {h:'蓮',m:'연꽃',s:'련'},{h:'煉',m:'달굴',s:'련'},{h:'聯',m:'잇닿을',s:'련'},
  {h:'嶺',m:'고개',s:'령'},{h:'令',m:'영',s:'령'},{h:'玲',m:'옥소리',s:'령'},{h:'靈',m:'신령',s:'령'},
  {h:'柳',m:'버드나무',s:'류'},{h:'流',m:'흐를',s:'류'},{h:'類',m:'무리',s:'류'},
  {h:'利',m:'이로울',s:'리'},{h:'理',m:'다스릴',s:'리'},{h:'李',m:'오얏',s:'리'},{h:'里',m:'마을',s:'리'},
  {h:'林',m:'수풀',s:'림'},{h:'琳',m:'아름다운옥',s:'림'},
  // ㅁ
  {h:'萬',m:'일만',s:'만'},{h:'滿',m:'찰',s:'만'},{h:'晩',m:'늦을',s:'만'},
  {h:'梅',m:'매화',s:'매'},{h:'妹',m:'누이',s:'매'},{h:'魅',m:'도깨비',s:'매'},
  {h:'明',m:'밝을',s:'명'},{h:'命',m:'목숨',s:'명'},{h:'鳴',m:'울',s:'명'},{h:'銘',m:'새길',s:'명'},
  {h:'武',m:'굳셀',s:'무'},{h:'茂',m:'무성할',s:'무'},{h:'務',m:'힘쓸',s:'무'},{h:'舞',m:'춤출',s:'무'},
  {h:'文',m:'글',s:'문'},{h:'門',m:'문',s:'문'},{h:'汶',m:'물이름',s:'문'},
  {h:'美',m:'아름다울',s:'미'},{h:'微',m:'작을',s:'미'},{h:'薇',m:'장미',s:'미'},{h:'渼',m:'물결',s:'미'},
  {h:'民',m:'백성',s:'민'},{h:'敏',m:'민첩할',s:'민'},{h:'旻',m:'하늘',s:'민'},{h:'玟',m:'옥돌',s:'민'},{h:'珉',m:'옥',s:'민'},
  // ㅂ
  {h:'朴',m:'순박할',s:'박'},{h:'珀',m:'호박',s:'박'},{h:'博',m:'넓을',s:'박'},
  {h:'培',m:'북돋울',s:'배'},{h:'裵',m:'성씨',s:'배'},
  {h:'凡',m:'무릇',s:'범'},{h:'範',m:'법',s:'범'},{h:'梵',m:'범어',s:'범'},
  {h:'炳',m:'빛날',s:'병'},{h:'丙',m:'남쪽',s:'병'},{h:'秉',m:'잡을',s:'병'},
  {h:'寶',m:'보배',s:'보'},{h:'甫',m:'클',s:'보'},{h:'輔',m:'도울',s:'보'},
  {h:'福',m:'복',s:'복'},{h:'馥',m:'향기로울',s:'복'},
  {h:'富',m:'부자',s:'부'},{h:'扶',m:'도울',s:'부'},{h:'浮',m:'뜰',s:'부'},
  // ㅅ
  {h:'思',m:'생각할',s:'사'},{h:'史',m:'역사',s:'사'},{h:'士',m:'선비',s:'사'},{h:'沙',m:'모래',s:'사'},
  {h:'山',m:'산',s:'산'},{h:'珊',m:'산호',s:'산'},
  {h:'相',m:'서로',s:'상'},{h:'尙',m:'오히려',s:'상'},{h:'祥',m:'상서로울',s:'상'},{h:'象',m:'코끼리',s:'상'},
  {h:'瑞',m:'상서로울',s:'서'},{h:'書',m:'글',s:'서'},{h:'西',m:'서쪽',s:'서'},{h:'緖',m:'실마리',s:'서'},
  {h:'善',m:'착할',s:'선'},{h:'仙',m:'신선',s:'선'},{h:'宣',m:'베풀',s:'선'},{h:'先',m:'먼저',s:'선'},
  {h:'誠',m:'정성',s:'성'},{h:'成',m:'이룰',s:'성'},{h:'星',m:'별',s:'성'},{h:'盛',m:'성할',s:'성'},
  {h:'世',m:'세상',s:'세'},{h:'歲',m:'해',s:'세'},
  {h:'素',m:'흴',s:'소'},{h:'昭',m:'밝을',s:'소'},{h:'小',m:'작을',s:'소'},{h:'韶',m:'아름다울',s:'소'},
  {h:'秀',m:'빼어날',s:'수'},{h:'洙',m:'물가',s:'수'},{h:'壽',m:'목숨',s:'수'},{h:'修',m:'닦을',s:'수'},{h:'水',m:'물',s:'수'},{h:'睡',m:'졸',s:'수'},{h:'遂',m:'이룰',s:'수'},
  {h:'順',m:'순할',s:'순'},{h:'純',m:'순수할',s:'순'},{h:'舜',m:'임금',s:'순'},
  {h:'承',m:'이을',s:'승'},{h:'勝',m:'이길',s:'승'},{h:'昇',m:'오를',s:'승'},
  {h:'詩',m:'시',s:'시'},{h:'施',m:'베풀',s:'시'},{h:'時',m:'때',s:'시'},{h:'始',m:'처음',s:'시'},
  {h:'信',m:'믿을',s:'신'},{h:'新',m:'새',s:'신'},{h:'神',m:'귀신',s:'신'},{h:'晨',m:'새벽',s:'신'},
  // ㅇ
  {h:'雅',m:'우아할',s:'아'},{h:'娥',m:'아름다울',s:'아'},{h:'芽',m:'싹',s:'아'},
  {h:'安',m:'편안할',s:'안'},{h:'岸',m:'언덕',s:'안'},{h:'顔',m:'얼굴',s:'안'},
  {h:'陽',m:'볕',s:'양'},{h:'洋',m:'큰바다',s:'양'},{h:'良',m:'어질',s:'양'},{h:'梁',m:'들보',s:'양'},
  {h:'姸',m:'고울',s:'연'},{h:'燕',m:'제비',s:'연'},{h:'延',m:'늘일',s:'연'},{h:'演',m:'펼',s:'연'},{h:'淵',m:'못',s:'연'},
  {h:'榮',m:'영화로울',s:'영'},{h:'英',m:'꽃부리',s:'영'},{h:'映',m:'비칠',s:'영'},{h:'瑛',m:'물빛옥',s:'영'},{h:'泳',m:'헤엄칠',s:'영'},
  {h:'叡',m:'밝을',s:'예'},{h:'藝',m:'재주',s:'예'},{h:'禮',m:'예도',s:'예'},
  {h:'悟',m:'깨달을',s:'오'},{h:'五',m:'다섯',s:'오'},{h:'午',m:'낮',s:'오'},
  {h:'玉',m:'구슬',s:'옥'},{h:'鈺',m:'보배',s:'옥'},
  {h:'龍',m:'용',s:'용'},{h:'勇',m:'날쌜',s:'용'},{h:'鎔',m:'녹일',s:'용'},{h:'湧',m:'솟을',s:'용'},
  {h:'宇',m:'집',s:'우'},{h:'禹',m:'임금',s:'우'},{h:'佑',m:'도울',s:'우'},{h:'祐',m:'도울',s:'우'},{h:'羽',m:'깃',s:'우'},{h:'雨',m:'비',s:'우'},
  {h:'元',m:'으뜸',s:'원'},{h:'源',m:'근원',s:'원'},{h:'遠',m:'멀',s:'원'},{h:'苑',m:'동산',s:'원'},{h:'圓',m:'둥글',s:'원'},
  {h:'有',m:'있을',s:'유'},{h:'裕',m:'넉넉할',s:'유'},{h:'柔',m:'부드러울',s:'유'},{h:'唯',m:'오직',s:'유'},{h:'悠',m:'멀',s:'유'},
  {h:'尹',m:'성씨',s:'윤'},{h:'允',m:'진실로',s:'윤'},{h:'潤',m:'불을',s:'윤'},{h:'胤',m:'이을',s:'윤'},
  {h:'銀',m:'은',s:'은'},{h:'恩',m:'은혜',s:'은'},{h:'殷',m:'성할',s:'은'},
  {h:'義',m:'옳을',s:'의'},{h:'意',m:'뜻',s:'의'},{h:'毅',m:'굳셀',s:'의'},
  {h:'怡',m:'기쁠',s:'이'},{h:'彛',m:'떳떳할',s:'이'},{h:'異',m:'다를',s:'이'},
  {h:'仁',m:'어질',s:'인'},{h:'寅',m:'공경할',s:'인'},{h:'引',m:'이끌',s:'인'},{h:'印',m:'도장',s:'인'},
  {h:'日',m:'날',s:'일'},{h:'一',m:'하나',s:'일'},{h:'逸',m:'편안할',s:'일'},{h:'溢',m:'넘칠',s:'일'},
  // ㅈ
  {h:'子',m:'아들',s:'자'},{h:'慈',m:'사랑할',s:'자'},{h:'紫',m:'자줏빛',s:'자'},{h:'玆',m:'이',s:'자'},
  {h:'長',m:'길',s:'장'},{h:'章',m:'글',s:'장'},{h:'壯',m:'씩씩할',s:'장'},{h:'莊',m:'엄숙할',s:'장'},{h:'璋',m:'홀',s:'장'},
  {h:'才',m:'재주',s:'재'},{h:'在',m:'있을',s:'재'},{h:'宰',m:'주관할',s:'재'},{h:'載',m:'실을',s:'재'},
  {h:'全',m:'온전할',s:'전'},{h:'田',m:'밭',s:'전'},{h:'典',m:'법',s:'전'},{h:'傳',m:'전할',s:'전'},
  {h:'正',m:'바를',s:'정'},{h:'貞',m:'곧을',s:'정'},{h:'靜',m:'고요할',s:'정'},{h:'晶',m:'맑을',s:'정'},{h:'政',m:'정사',s:'정'},
  {h:'照',m:'비칠',s:'조'},{h:'造',m:'지을',s:'조'},{h:'祚',m:'복',s:'조'},{h:'朝',m:'아침',s:'조'},
  {h:'珠',m:'구슬',s:'주'},{h:'柱',m:'기둥',s:'주'},{h:'周',m:'두루',s:'주'},{h:'住',m:'살',s:'주'},{h:'宙',m:'집',s:'주'},
  {h:'俊',m:'준걸',s:'준'},{h:'峻',m:'높을',s:'준'},{h:'晙',m:'밝을',s:'준'},{h:'浚',m:'깊을',s:'준'},{h:'準',m:'고를',s:'준'},
  {h:'智',m:'슬기로울',s:'지'},{h:'志',m:'뜻',s:'지'},{h:'知',m:'알',s:'지'},{h:'池',m:'못',s:'지'},{h:'芝',m:'지초',s:'지'},
  {h:'眞',m:'참',s:'진'},{h:'珍',m:'보배',s:'진'},{h:'振',m:'떨칠',s:'진'},{h:'進',m:'나아갈',s:'진'},{h:'鎭',m:'진압할',s:'진'},
  // ㅊ
  {h:'贊',m:'도울',s:'찬'},{h:'燦',m:'빛날',s:'찬'},{h:'璨',m:'구슬빛',s:'찬'},
  {h:'彩',m:'빛',s:'채'},{h:'蔡',m:'성씨',s:'채'},
  {h:'天',m:'하늘',s:'천'},{h:'千',m:'일천',s:'천'},{h:'泉',m:'샘',s:'천'},{h:'川',m:'내',s:'천'},
  {h:'哲',m:'밝을',s:'철'},{h:'徹',m:'통할',s:'철'},{h:'鐵',m:'쇠',s:'철'},
  {h:'靑',m:'푸를',s:'청'},{h:'淸',m:'맑을',s:'청'},{h:'晴',m:'갤',s:'청'},
  {h:'初',m:'처음',s:'초'},{h:'草',m:'풀',s:'초'},{h:'楚',m:'초나라',s:'초'},
  {h:'春',m:'봄',s:'춘'},{h:'椿',m:'참죽나무',s:'춘'},
  // ㅌ
  {h:'太',m:'클',s:'태'},{h:'泰',m:'클',s:'태'},{h:'台',m:'별',s:'태'},{h:'兌',m:'기쁠',s:'태'},
  // ㅎ
  {h:'夏',m:'여름',s:'하'},{h:'河',m:'강물',s:'하'},{h:'賀',m:'하례할',s:'하'},{h:'荷',m:'연꽃',s:'하'},
  {h:'何',m:'어찌',s:'하'},{h:'下',m:'아래',s:'하'},{h:'霞',m:'노을',s:'하'},{h:'廈',m:'큰집',s:'하'},
  {h:'漢',m:'한나라',s:'한'},{h:'韓',m:'나라이름',s:'한'},{h:'翰',m:'편지',s:'한'},{h:'恨',m:'한할',s:'한'},
  {h:'海',m:'바다',s:'해'},{h:'亥',m:'돼지',s:'해'},{h:'解',m:'풀',s:'해'},{h:'諧',m:'화할',s:'해'},
  {h:'香',m:'향기',s:'향'},{h:'鄕',m:'고향',s:'향'},
  {h:'賢',m:'어질',s:'현'},{h:'鉉',m:'솥귀',s:'현'},{h:'玄',m:'검을',s:'현'},{h:'炫',m:'빛날',s:'현'},{h:'絃',m:'줄',s:'현'},
  {h:'惠',m:'은혜',s:'혜'},{h:'慧',m:'슬기로울',s:'혜'},
  {h:'浩',m:'넓을',s:'호'},{h:'昊',m:'하늘',s:'호'},{h:'虎',m:'범',s:'호'},{h:'好',m:'좋을',s:'호'},{h:'湖',m:'호수',s:'호'},
  {h:'洪',m:'넓을',s:'홍'},{h:'弘',m:'넓을',s:'홍'},{h:'紅',m:'붉을',s:'홍'},
  {h:'和',m:'화할',s:'화'},{h:'華',m:'빛날',s:'화'},{h:'花',m:'꽃',s:'화'},{h:'火',m:'불',s:'화'},
  {h:'桓',m:'굳셀',s:'환'},{h:'煥',m:'빛날',s:'환'},{h:'歡',m:'기쁠',s:'환'},{h:'幻',m:'변화할',s:'환'},
  {h:'孝',m:'효도',s:'효'},{h:'曉',m:'새벽',s:'효'},{h:'效',m:'본받을',s:'효'},
  {h:'勳',m:'공',s:'훈'},{h:'薰',m:'향기',s:'훈'},{h:'熏',m:'연기',s:'훈'},{h:'壎',m:'악기',s:'훈'},{h:'訓',m:'가르칠',s:'훈'},
  // 휘
  {h:'輝',m:'빛날',s:'휘'},{h:'暉',m:'햇빛',s:'휘'},{h:'徽',m:'아름다울',s:'휘'},
  // 흠
  {h:'欽',m:'공경할',s:'흠'},
  // 희
  {h:'熙',m:'빛날',s:'희'},{h:'姬',m:'아름다울',s:'희'},{h:'喜',m:'기쁠',s:'희'},{h:'希',m:'바랄',s:'희'},
  {h:'羲',m:'복희',s:'희'},{h:'憙',m:'기쁠',s:'희'},{h:'禧',m:'복',s:'희'},{h:'曦',m:'햇빛',s:'희'},
];
...
(function(){
  const extra = [
    // 각
    {h:'覺',m:'깨달을',s:'각'},{h:'各',m:'각각',s:'각'},{h:'角',m:'뿔',s:'각'},{h:'珏',m:'두옥',s:'각'},
    // 간
    {h:'干',m:'방패',s:'간'},{h:'諫',m:'간할',s:'간'},{h:'澗',m:'산골물',s:'간'},{h:'幹',m:'줄기',s:'간'},
    // 갈
    {h:'渴',m:'목마를',s:'갈'},{h:'葛',m:'칡',s:'갈'},
    // 감
    {h:'感',m:'느낄',s:'감'},{h:'甘',m:'달',s:'감'},{h:'鑑',m:'거울',s:'감'},{h:'堪',m:'견딜',s:'감'},{h:'勘',m:'헤아릴',s:'감'},
    // 개
    {h:'介',m:'낄',s:'개'},{h:'開',m:'열',s:'개'},{h:'凱',m:'개선할',s:'개'},{h:'愷',m:'즐거울',s:'개'},{h:'鎧',m:'갑옷',s:'개'},
    // 거
    {h:'居',m:'살',s:'거'},{h:'擧',m:'들',s:'거'},{h:'巨',m:'클',s:'거'},{h:'渠',m:'도랑',s:'거'},
    // 겸
    {h:'謙',m:'겸손할',s:'겸'},{h:'兼',m:'겸할',s:'겸'},{h:'鎌',m:'낫',s:'겸'},
    // 곤
    {h:'坤',m:'땅',s:'곤'},{h:'崑',m:'산이름',s:'곤'},{h:'琨',m:'아름다운돌',s:'곤'},{h:'昆',m:'맏',s:'곤'},
    // 군
    {h:'君',m:'임금',s:'군'},{h:'軍',m:'군사',s:'군'},{h:'群',m:'무리',s:'군'},{h:'郡',m:'고을',s:'군'},
    // 균
    {h:'均',m:'고를',s:'균'},{h:'筠',m:'대나무',s:'균'},{h:'鈞',m:'무게',s:'균'},
    // 극
    {h:'克',m:'이길',s:'극'},{h:'極',m:'극',s:'극'},
    // 달
    {h:'達',m:'통달할',s:'달'},{h:'怛',m:'슬플',s:'달'},
    // 담
    {h:'淡',m:'맑을',s:'담'},{h:'湛',m:'잠길',s:'담'},{h:'澹',m:'맑을',s:'담'},{h:'覃',m:'깊을',s:'담'},
    // 돈
    {h:'敦',m:'도타울',s:'돈'},{h:'燉',m:'빛날',s:'돈'},{h:'惇',m:'도타울',s:'돈'},
    // 두
    {h:'斗',m:'말',s:'두'},{h:'杜',m:'막을',s:'두'},{h:'豆',m:'콩',s:'두'},
    // 득
    {h:'得',m:'얻을',s:'득'},
    // 래
    {h:'來',m:'올',s:'래'},{h:'萊',m:'명아주',s:'래'},
    // 록
    {h:'綠',m:'푸를',s:'록'},{h:'祿',m:'복',s:'록'},{h:'鹿',m:'사슴',s:'록'},{h:'錄',m:'기록할',s:'록'},
    // 룡
    {h:'龍',m:'용',s:'룡'},
    // 립
    {h:'立',m:'설',s:'립'},
    // 맹
    {h:'孟',m:'맏',s:'맹'},{h:'猛',m:'사나울',s:'맹'},{h:'盟',m:'맹세',s:'맹'},
    // 목
    {h:'木',m:'나무',s:'목'},{h:'睦',m:'화목할',s:'목'},{h:'穆',m:'화목할',s:'목'},
    // 반
    {h:'伴',m:'짝',s:'반'},{h:'班',m:'나눌',s:'반'},{h:'磻',m:'강이름',s:'반'},{h:'盤',m:'소반',s:'반'},
    // 백
    {h:'白',m:'흴',s:'백'},{h:'百',m:'일백',s:'백'},{h:'柏',m:'잣나무',s:'백'},{h:'魄',m:'넋',s:'백'},
    // 봉
    {h:'鳳',m:'봉황',s:'봉'},{h:'峰',m:'봉우리',s:'봉'},{h:'奉',m:'받들',s:'봉'},{h:'逢',m:'만날',s:'봉'},{h:'烽',m:'봉화',s:'봉'},
    // 빈
    {h:'彬',m:'빛날',s:'빈'},{h:'斌',m:'빛날',s:'빈'},{h:'賓',m:'손님',s:'빈'},{h:'玭',m:'구슬',s:'빈'},
    // 삼
    {h:'三',m:'석',s:'삼'},{h:'森',m:'빽빽할',s:'삼'},{h:'參',m:'참여할',s:'삼'},
    // 손
    {h:'孫',m:'손자',s:'손'},{h:'巽',m:'공손할',s:'손'},
    // 송
    {h:'松',m:'소나무',s:'송'},{h:'宋',m:'나라이름',s:'송'},{h:'頌',m:'기릴',s:'송'},{h:'誦',m:'외울',s:'송'},
    // 숙
    {h:'淑',m:'맑을',s:'숙'},{h:'肅',m:'엄숙할',s:'숙'},{h:'宿',m:'별',s:'숙'},{h:'熟',m:'익을',s:'숙'},
    // 승
    {h:'承',m:'이을',s:'승'},{h:'勝',m:'이길',s:'승'},{h:'昇',m:'오를',s:'승'},{h:'丞',m:'도울',s:'승'},{h:'升',m:'되',s:'승'},
    // 언
    {h:'彦',m:'선비',s:'언'},{h:'言',m:'말씀',s:'언'},
    // 열
    {h:'悅',m:'기쁠',s:'열'},{h:'烈',m:'빛날',s:'열'},{h:'熱',m:'더울',s:'열'},
    // 염
    {h:'廉',m:'청렴할',s:'염'},{h:'炎',m:'불꽃',s:'염'},{h:'艶',m:'고울',s:'염'},
    // 온
    {h:'溫',m:'따뜻할',s:'온'},{h:'穩',m:'평온할',s:'온'},
    // 완
    {h:'完',m:'완전할',s:'완'},{h:'玩',m:'희롱할',s:'완'},{h:'婉',m:'예쁠',s:'완'},
    // 운
    {h:'雲',m:'구름',s:'운'},{h:'韻',m:'운',s:'운'},{h:'芸',m:'향풀',s:'운'},
    // 웅
    {h:'雄',m:'수컷',s:'웅'},
    // 월
    {h:'月',m:'달',s:'월'},{h:'越',m:'넘을',s:'월'},
    // 익
    {h:'益',m:'더할',s:'익'},{h:'翊',m:'도울',s:'익'},{h:'翼',m:'날개',s:'익'},
    // 작
    {h:'爵',m:'벼슬',s:'작'},{h:'昨',m:'어제',s:'작'},
    // 잠
    {h:'潛',m:'잠길',s:'잠'},
    // 제
    {h:'齊',m:'가지런할',s:'제'},{h:'制',m:'만들',s:'제'},{h:'帝',m:'임금',s:'제'},{h:'際',m:'사이',s:'제'},
    // 종
    {h:'宗',m:'마루',s:'종'},{h:'鍾',m:'쇠북',s:'종'},{h:'從',m:'따를',s:'종'},{h:'綜',m:'모을',s:'종'},
    // 중
    {h:'中',m:'가운데',s:'중'},{h:'重',m:'무거울',s:'중'},{h:'仲',m:'버금',s:'중'},
    // 창
    {h:'昌',m:'창성할',s:'창'},{h:'暢',m:'펼',s:'창'},{h:'彰',m:'드러날',s:'창'},{h:'倉',m:'곳집',s:'창'},
    // 총
    {h:'聰',m:'귀밝을',s:'총'},{h:'總',m:'모두',s:'총'},
    // 충
    {h:'忠',m:'충성',s:'충'},{h:'沖',m:'빌',s:'충'},{h:'充',m:'채울',s:'충'},
    // 택
    {h:'澤',m:'못',s:'택'},{h:'宅',m:'집',s:'택'},
    // 풍
    {h:'楓',m:'단풍나무',s:'풍'},{h:'豊',m:'풍성할',s:'풍'},{h:'風',m:'바람',s:'풍'},
    // 학
    {h:'學',m:'배울',s:'학'},{h:'鶴',m:'학',s:'학'},
    // 헌
    {h:'憲',m:'법',s:'헌'},{h:'軒',m:'처마',s:'헌'},
    // 혁
    {h:'赫',m:'빛날',s:'혁'},{h:'革',m:'가죽',s:'혁'},{h:'爀',m:'빛날',s:'혁'},
    // 황
    {h:'黃',m:'누를',s:'황'},{h:'晃',m:'밝을',s:'황'},{h:'煌',m:'빛날',s:'황'},{h:'凰',m:'봉황',s:'황'},
  ];
  extra.forEach(e => HANJA_SEARCH_DB.push(e));
})();
...
function initHanjaPanel() {
  ...
  function renderPanel() {
    ...
    const searchResults = document.getElementById('hanja-search-results');
    ...
    searchInput.addEventListener('input', () => {
      ...
      searchResults.innerHTML = results.slice(0, 24).map(r =>
        `<button class="hanja-chip"
          onclick="selectHanja('${r.s}','${r.h}',this)">
          ${r.h}<span class="chip-meaning">${r.m} ${r.s}</span>
        </button>`
      ).join('');
    });
  ...
  nameInput.addEventListener('input', renderPanel);
  ...
  nameInput.addEventListener('focus', () => {
    if (nameInput.value.trim()) renderPanel();
  });

  window.selectHanja = (syllable, hanja) => {
